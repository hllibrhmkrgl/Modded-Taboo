...
const createTextShadowStyle = (textShadowProps) => {
  if (Platform.OS === 'ios') {
    ...
    // Android doesn't support textShadow well, return empty object
    return {};
  }
};
...
export const GameStyles = StyleSheet.create({
  ...
  // Super Tabu Effect Styles
  superTabuEffectOverlay: {
    position: 'absolute',
    top: 0,
    left: 0,
    right: 0,
...
// Team Names Screen Styles
export const TeamNamesStyles = StyleSheet.create({
  header: {
    alignItems: 'center',
    marginBottom: 30,
    paddingHorizontal: 20,
